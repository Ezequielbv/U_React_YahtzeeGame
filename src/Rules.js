class Rule {
  constructor(params) {
    //Put all properties in paramas on instance
...
const twos = new TotalOneNumber({ val: 2, description: "2 point per 1" });
...
const threeOfKind = new SumDistro({ count: 3, description: "Summ all dice if 3 are the same" });
